                            ...
                            child: Container(
                              child: ListView(
                                ...
                                children: <Widget>[
                                  ...
                                  (jenjangDiploma) ? Text('Jenjang: Diploma'): (jenjangSarjana) ? Text('Jenjang: Sarjana') : (jenjangMagister) ? Text('Jenjang: Magister') : Text('Jenjang: Doktor'),
                                  Text('Umur: ' + umur.toString()),
                                  Text('Kelas PBP: ' + kelasPBP),
                                  (_nilaiSwitch) ? Text('Practice Mode: Yes') : Text('Practice Mode: No'),
                                  TextButton(
                                    onPressed: () {
